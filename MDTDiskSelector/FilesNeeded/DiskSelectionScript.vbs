...
Sub Run_PS_Script()
    ...
    Command = "cmd /c echo Get-WmiObject win32_diskdrive ^| Select-Object Model, @{n='Disk Number'; e={$_.Index}}, @{n='Size / GB';e={[math]::truncate($_.size / 1GB)}} ^| Fl ^| Out-File X:\Windows\Temp\output.txt -Encoding ascii > X:\Windows\Temp\process.ps1"
